...
#[test]
fn top_status_bar_layout_matches_sync_first_class_action_budget() {
    ...
    assert_eq!(ShellMetrics::TITLEBAR_UTILITY_WIDTH, 220);
...
fn top_status_bar_tooltip_budget_matches_bugfix3_overlay_design() {
    ...
    assert_eq!(ShellMetrics::TITLEBAR_TOOLTIP_MIN_WIDTH, 96);
}
