...
```bash
git add ui/components/assets-ssh-connection-modal.slint ui/app-window.slint src/app/bootstrap.rs src/shell/view_model.rs tests/assets_modal_smoke.rs tests/assets_modal_ui_contract_smoke.sh tests/shell_view_model.rs tests/bootstrap_smoke.rs tests/ssh_profile_spec.rs
