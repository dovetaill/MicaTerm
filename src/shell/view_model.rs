...
pub struct ShellViewModel {
    ...
    pub workspace_sftp_path_editing: bool,
    pub workspace_sftp_focus_sequence: i32,
    pub workspace_sftp_last_rendered_session_id: Option<String>,
...
impl Default for ShellViewModel {
    fn default() -> Self {
        Self {
            ...
            workspace_sftp_path_editing: false,
            workspace_sftp_focus_sequence: 0,
            workspace_sftp_last_rendered_session_id: None,
