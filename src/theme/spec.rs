...
pub fn terminal_palette_spec(theme_mode: ThemeMode) -> ThemeTerminalPaletteSpec {
    match theme_mode {
        ThemeMode::Dark => ThemeTerminalPaletteSpec {
            ...
            jump_to_latest_bg: 0x31_3244,
            jump_to_latest_hover_bg: 0x45_475a,
            jump_to_latest_pressed_bg: 0x58_5b70,
            jump_to_latest_border: 0x6c_7086,
            jump_to_latest_fg: 0xcd_d6f4,
            split: 0x31_3244,
            ansi: [
                0x45_475a,
                0xf3_8ba8,
        ...
        ThemeMode::Light => ThemeTerminalPaletteSpec {
            ...
            jump_to_latest_bg: 0xcc_d0da,
            jump_to_latest_hover_bg: 0xbc_c0cc,
            jump_to_latest_pressed_bg: 0xac_b0be,
            jump_to_latest_border: 0x9c_a0b0,
            jump_to_latest_fg: 0x4c_4f69,
            split: 0xcc_d0da,
            ansi: [
                0x5c_5f77,
                0xd2_0f39,
